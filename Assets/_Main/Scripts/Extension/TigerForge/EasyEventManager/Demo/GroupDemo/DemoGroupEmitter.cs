...
public class DemoGroupEmitter : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Debug.Log("<color=green>I'mat the Emitter: I emitted <b>ON_ENEMY_SPAWNED</b> <list1>event</list1> with random data managed by <b>SetDataGroup</b> method.</color>\n");
        ...
        {
            Debug.Log("<color=green>I'mat the Emitter: I emitted <b>ON_ENEMY_KILLED</b> <list1>event</list1> with some data managed by <b>SetIndexedDataGroup</b> method.</color>\n");
        ...
        {
            Debug.Log("<color=green>I'mat the Emitter: I emitted <b>ON_COIN_TAKEN</b> <list1>event</list1> with value 50 using the <b>EmitEventData</b> method.</color>\n");
