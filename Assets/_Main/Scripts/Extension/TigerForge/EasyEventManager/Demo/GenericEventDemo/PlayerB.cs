...
public class PlayerB : MonoBehaviour
{
    ...
    void MyCallBackFunction()
    {
        ...
        myCoins += coins;
        Debug.Log("<color=cyan>I'mat PlayerB! I found " + coins + " coins and now I've got " + myCoins + " coins in total.</color>\n");
    }

    void WhoIAmCallBack1()
    {
        Debug.Log("<color=cyan>I'mat PlayerB!</color>\n");
    }

    void WhoIAmCallBack2()
    {
        var sender = (GameObject)EventManager.GetSender("PRESSED_D");
        Debug.Log("<color=cyan>I'mat PlayerB! The Object (sender) who emitted this event is: " + sender.name + "</color>\n");
    }
}
