...
public class PlayerC : MonoBehaviour
{
    ...
    void MyCallBackFunction()
    {
        ...
        Debug.Log("<color=cyan>I'mat PlayerC! I found a power up and now my Strenght is " + powerup + ".</color>\n");
    }

    void WhoIAmCallBack1()
    {
        Debug.Log("<color=cyan>I'mat PlayerC!</color>\n");
    }

    void WhoIAmCallBack2()
    {
        var sender = (GameObject)EventManager.GetSender("PRESSED_D");
        Debug.Log("<color=cyan>I'mat PlayerC! The Object (sender) who emitted this event is: " + sender.name + "</color>\n");
    }
}
